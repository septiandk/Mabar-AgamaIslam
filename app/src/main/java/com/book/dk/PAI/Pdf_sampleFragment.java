...
public class Pdf_sampleFragment extends Fragment implements OnPageChangeListener, OnLoadCompleteListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (pos == 0) {
            displayFromAsset("introduction.pdf");

        }
        else if (pos == 1) {
            displayFromAsset("pelajaran2.pdf");

        }
        else if (pos == 2) {
            displayFromAsset("pelajaran3.pdf");

        }
        else if (pos == 3) {
            displayFromAsset("pelajaran4.pdf");

        }
        else if (pos == 4) {
            displayFromAsset("pelajaran5.pdf");

        }
        else if (pos == 5) {
            displayFromAsset("pelajaran6.pdf");

        }
        else if (pos == 6) {
            displayFromAsset("pelajaran7.pdf");

        }
        else if (pos == 7) {
            displayFromAsset("pelajaran8.pdf");

        }
        else if (pos == 8) {
            displayFromAsset("pelajaran9.pdf");

        }
        else if (pos == 9) {
            displayFromAsset("penutup.pdf");
